...
//	}
	...
	public GUI_Dau_sach() {
		...
		btnThem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtMaDauSach.getText().isEmpty() || (txtTenSach.getText().isEmpty()) || txtSoLuong.getText().isEmpty() || txtTacGia.getText().isEmpty() ||txtTheLoai.getText().isEmpty() || txtNamXB.getText().isEmpty() || txtNXB.getText().isEmpty()) {
		...
		lblNmXutBn.setBounds(421, 160, 96, 38);
		...
		lblbg.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/dried-flowers-notebook.jpg")));
