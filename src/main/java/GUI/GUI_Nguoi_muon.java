...
public class GUI_Nguoi_muon extends JFrame {
	...
	public GUI_Nguoi_muon() {
		...
		btnLm.setBackground(Color.BLUE);
		btnLm.setForeground(Color.BLACK);
		...
		lblbg.setIcon(new ImageIcon(GUI_Nguoi_muon.class.getResource("/img/dried-flowers-notebook.jpg")));
