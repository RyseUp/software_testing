...
public class GUI_TrangChu extends JFrame {
	...
	public GUI_TrangChu() {
		...
		JMenu mntmNewMenuItem1 = new JMenu("Thông tin tài khoản");
		mntmNewMenuItem1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "Tài khoản truy cập: ADMIN" , "Thông tin tài khoản", 1);
			}
		});
		...
		mntmNewMenuItem1.setFont(new Font("Segoe UI", Font.BOLD, 15));
		menuBar.add(mntmNewMenuItem1);
		
		mntmNewMenuItem1.setFont(new Font("Segoe UI", Font.BOLD, 15));
		mnHethong.add(mntmNewMenuItem1);
		...
		mnNewMenu_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "Hotline: (+84)012345678 " , "Liên hệ", 1);
			}
		});
		...
		btnQLDS.setBackground(Color.blue);
		btnQLDS.setForeground(Color.GRAY);
		...
		btnQLS.setBackground(Color.BLUE);
		btnQLS.setForeground(Color.GRAY);
		...
		btnQLMN.setBackground(Color.BLUE);
		btnQLMN.setForeground(Color.GRAY);
		...
		btnQLPM.setBackground(Color.BLUE);
		btnQLPM.setForeground(Color.GRAY);
		btnQLPM.addActionListener(new ActionListener() {
			...
			//ImageIcon icon = new ImageIcon("path/book.png");
			//JButton button = new JButton();
			//btnQLPM.setIcon(icon);
		...
		btnTK.setBackground(Color.BLUE);
		btnTK.setForeground(Color.GRAY);
		...
		lblNewLabel.setIcon(new ImageIcon(GUI_TrangChu.class.getResource("/img/mo2ndcommonlineuse.gif")));
