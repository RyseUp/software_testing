...
public class GUI_ThongKe extends JFrame {
	...
	public GUI_ThongKe() {
		...
		lblbg.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/sach.jpg")));
		lblbg.setBounds(0, 0, 1032, 872);
		panelDauSach.add(lblbg);
		...
		JLabel lblsach = new JLabel("New label");
		lblsach.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/sach.jpg")));
		lblsach.setBounds(0, 0, 1032, 872);
		panelSach.add(lblsach);
		...
		JLabel lblmuon = new JLabel("New label");
		lblmuon.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/sach.jpg")));
		lblmuon.setBounds(0, 0, 1032, 872);
		panelNguoiMuon.add(lblmuon);
		...
		JLabel lblthongke = new JLabel("New label");
		lblthongke.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/sach.jpg")));
		lblthongke.setBounds(0, 0, 1032, 872);
		panelThongKe.add(lblthongke);
		
		JLabel lblphieumuon = new JLabel("New label");
		lblphieumuon.setIcon(new ImageIcon(GUI_Dau_sach.class.getResource("/img/sach.jpg")));
		lblphieumuon.setBounds(0, 0, 1032, 872);
		panelPhieuMuon.add(lblphieumuon);
